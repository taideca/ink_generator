const STAGES_DATA = [
    {
        ...
        targets: [{ obj: 'logo', shape: 'rect', tx: 0.64, ty: 0.44, tw: 0.2, th: 0.5, found: false}]
    },
    {
        // --- Stage 1 ---
        objects: [
    ...
    },
    {
        // --- Stage 2 ---
        objects: [
            { id: 'dice1', type: 'image', content: 'dice123', x: 0.5, y: 0.1, w: 100, h: 100 },
            { id: 'dice2', type: 'image', content: 'dice263', x: 0.7, y: 0.3, w: 100, h: 100 },
            { id: 'dice3', type: 'image', content: 'dice312', x: 0.3, y: 0.9, w: 100, h: 100 },
            { id: 'dice4', type: 'image', content: 'dice421', x: 0.1, y: 0.4, w: 100, h: 100 },
            { id: 'dice5', type: 'image', content: 'dice462', x: 0.4, y: 0.5, w: 100, h: 100 },
            { id: 'dice6', type: 'image', content: 'dice536', x: 0.8, y: 0.8, w: 100, h: 100 },
            { id: 'dice7', type: 'image', content: 'dice645', x: 0.3, y: 0.2, w: 100, h: 100 },
